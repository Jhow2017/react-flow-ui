...
export type AlignItems = 'flex-start' | 'flex-end' | 'center' | 'baseline' | 'stretch' | GlobalValues;
...
export type FlexDirection = 'row' | 'row-reverse' | 'column' | 'column-reverse' | GlobalValues;
...
export type Position = 'static' | 'relative' | 'absolute' | 'fixed' | 'sticky' | GlobalValues;
...
export type TextDecoration = 'none' | 'underline' | 'overline' | 'line-through' | 'blink' | GlobalValues;

export type TextTransform = 'none' | 'capitalize' | 'uppercase' | 'lowercase' | GlobalValues;
...
export type FontFamily = 'var(--primaryFont)' | 'var(--secondaryFont)' | GlobalValues;
...
export type BackgroundRepeat = 'repeat' | 'repeat-x' | 'repeat-y' | 'no-repeat' | GlobalValues;

export type BackgroundSize = 'cover' | 'contain' | GlobalValues;

export type ObjectFit = 'contain' | 'cover' | 'fill' | 'none' | 'scale-down' | GlobalValues;
